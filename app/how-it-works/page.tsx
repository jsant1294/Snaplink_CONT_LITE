            ...
            <div className="space-y-8">
              {steps.map((step, i) => (
                <div key={i} className="flex gap-5 items-start">
                  <div className="w-12 h-12 rounded-2xl bg-gold/10 border border-gold/20 flex items-center justify-center text-xl shrink-0">
                    {step.icon}
                  </div>
                  <div>
                    ...
                    <h2 className="font-display text-xl text-obsidian mt-1 mb-2">{step.title}</h2>
                    <p className="text-clay leading-relaxed">{step.desc}</p>
                  </div>
                </div>
              ))}
            </div>
        ...
        <section className="bg-obsidian py-16 text-center">
          <div className="max-w-xl mx-auto px-4">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <a href="/planner" className="bg-gold text-obsidian font-semibold px-8 py-3.5 rounded-xl">
                {t("startPlanning", lang)}
              </a>
              <a href="/book" className="border border-bone/20 text-cream font-medium px-8 py-3.5 rounded-xl hover:bg-bone/5">
